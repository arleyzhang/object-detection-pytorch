...
class DRN(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000,
        ...
        # # v32
        # self.layer4 = self._make_layer(block, channels[3], layers[3], stride=2, dilation=2)
...
def drn_d_22(**kwargs):
    model = DRN(BasicBlock, [1, 1, 2, 2, 2, 2, 1, 1, 1, 1, 1],
                channels=drn_channels['drn_d_22'], out_middle=True, arch='D', **kwargs)
    return model
