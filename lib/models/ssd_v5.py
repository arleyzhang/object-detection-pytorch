...
predict_conv_source = {
    'ssd300': {
        ...
        # # V26
        # 'drn_d_24': ['base.layer4.1.conv2', 'base.layer5.1.conv2',
        #           'base.layer6.1.conv2', 'base.layer7.0', 'base.layer8.0', 'base.layer9.0'],

        # V30
        'drn_d_24': ['base.layer4.1.conv2', 'base.layer5.1.conv2',
                  'base.layer6.1.conv2', 'base.layer7.3', 'base.layer8.3', 'base.layer9.3'],
    },
    'ssd321': {
        # # v9
...
predict_relu_source = {
    'ssd300': {
        ...
        # # V26
        # 'drn_d_24': ['base.layer4.1.relu2', 'base.layer5.1.relu2',
        #           'base.layer6.1.relu2', 'base.layer7.2', 'base.layer8.2', 'base.layer9.1'],

        # V30
        'drn_d_24': ['base.layer4.1.relu2', 'base.layer5.1.relu2',
                     'base.layer6.1.relu2', 'base.layer7.5', 'base.layer8.5', 'base.layer9.5'],
    },
    'ssd321': {
        # # v9
...
# conv: (n,k,s,p,c) means: type of layers, kernel_size,stride,padding,out_channel
